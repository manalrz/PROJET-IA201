...
# === Dataset personnalisé pour Melanoma (Benign / Malignant) ===
...
# === Modèle de Transfer Learning avec ResNet18 figé ===
class TransferNet(nn.Module):
    def __init__(self):
        ...
        self.features = nn.Sequential(*list(base.children())[:-1])  # Supprime fc
